  ...
  return (
    <div className="session-meter">
      <span className="session-meter__badge">
        <span className="pulse-dot" aria-hidden="true" /> PayPal auto-pay connected
      </span>
